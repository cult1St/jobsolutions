...
if(isset($profile) && !empty($profile)){
   $userFullName = $profile['jobSeeker_firstName'] ?? '' . " " . $profile['jobSeeker_lastName'] ?? '';
}
?>
<!DOCTYPE html>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Available Jobs -->
                    <li class="menu-item <?= ($active == 'available_jobs') ? 'active' : '' ?>">
                        <a href="<?= base_url() ?>employeepage.php" class="menu-link">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span
                                                        class="fw-semibold d-block"><?= $userFullName ?></span>
